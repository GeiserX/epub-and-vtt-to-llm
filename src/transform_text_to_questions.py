...
try:
    ...
    with open('E:/generated_output.txt', 'w', encoding='utf-8') as f:
        f.write(generated_text)
    print("Generated text saved to E:/generated_output.txt for manual inspection.")
    output_data = []

# Write the output data to a new JSONL file
output_file = 'E:/qa_data.jsonl'
